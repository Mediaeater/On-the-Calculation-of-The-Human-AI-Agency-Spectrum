...
Reference formats for the Human-AI Agency Framework

When referencing this framework in academic papers, reports, or other publications, please use one of the citation formats below.
...
```bibtex
@misc{ghuneim2026agency,
  author       = {Ghuneim, Mark},
  title        = {Distributed Agency in Human-AI Systems:
                  A Framework for Analyzing Authorship,
...
For informal use, presentations, or web links:

> Human-AI Agency Framework by Mark Ghuneim / NARRATIVE.NEW (2026). CC BY 4.0.

Or with a link:

> Based on the [Human-AI Agency Framework](https://narrativelabs.org/agency-framework)
...
This work is licensed under [Creative Commons Attribution 4.0 International (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/). You are free to share and adapt the material for any purpose, including commercial use, provided you give appropriate credit.
